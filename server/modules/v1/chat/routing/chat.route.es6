import {
  ...
  chatListSearchMessage, chatListSearchContact, chatMessageStatusUpdate
...
const chatroute = app => {
  ...
  app.post("/chat/message/status-update", commonValidator('v1/schema/chat/chat-message-status-update'), chatMessageStatusUpdate);
